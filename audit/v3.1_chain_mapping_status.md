...
1. `prop:R1_classical_mass`
   - `paper/v3.1/A_Reduction_Framework_RH.tex:4633`
2. `prop:R1_classical_mass_applicability`
   - `paper/v3.1/A_Reduction_Framework_RH.tex:4651`
3. `thm:R1-limit-point`
   - `paper/v3.1/A_Reduction_Framework_RH.tex:4672`
   - uses classical mass branch at `paper/v3.1/A_Reduction_Framework_RH.tex:4705`
4. RH closure call path
   - `paper/v3.1/A_Reduction_Framework_RH.tex:1002`
   - RH conclusion statement at `paper/v3.1/A_Reduction_Framework_RH.tex:1023`
